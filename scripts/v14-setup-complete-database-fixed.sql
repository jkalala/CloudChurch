-- Complete database setup script for Smart Church Management App (FIXED VERSION)
-- This script runs all necessary steps in the correct order without column errors
